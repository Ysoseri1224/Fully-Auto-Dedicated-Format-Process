...
### Help 视图
- 新增第五视图「帮助」，包含检查更新、使用说明、关于/反馈三个板块
- 侧边栏"帮助"入口与左下角 i 按钮功能相同（用户友好的重复设计）
- i 按钮不再弹 alert，改为直接切换到帮助视图

### 强制更新弹窗
- 更新下载完成后，主进程直接弹出系统原生对话框（立即重启/稍后）
- 不再需要用户主动点击按钮才能看到更新提示

### 检查更新面板
- 帮助视图中显示当前版本号（动态读取）
- 提供手动"检查更新"按钮，实时显示检查/下载/完成状态

## 0.6.3 (测试版本)

- 无实际功能修改，用于验证自动更新流程和 Release 工作流
